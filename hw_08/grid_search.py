...
if __name__ == "__main__":
    ...
    estimator = sklearn.pipeline.Pipeline(
        steps=[
            ...
            ("poly_gen", sklearn.preprocessing.PolynomialFeatures()),
            (
                "clf",
    ...
    gscv = sklearn.model_selection.GridSearchCV(
        estimator=estimator, param_grid=param_space, cv=cv
    )
    ...
    test_accuracy = gscv.score(test_data, test_target)
